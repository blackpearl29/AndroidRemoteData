...
public class NewProductActivity extends Activity {
	...
	class CreateNewProduct extends AsyncTask<String, String, String> {
		...
		protected String doInBackground(String... args) {
			...
			//extra
			String female = inputFmink.getText().toString();
			String male = inputMmink.getText().toString();
			...
			//extra 
			params.add(new BasicNameValuePair("female", female));
			params.add(new BasicNameValuePair("male", female));
