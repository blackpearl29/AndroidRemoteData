...
public class EditProductActivity extends Activity {
				...
				public void run() {
					...
					try {
						...
						if (success == 1) {
							...
							//extra
							txtFmink = (EditText) findViewById(R.id.inputFmink);
							txtMmink = (EditText) findViewById(R.id.inputMmink);
							...
							//extra
							txtFmink.setText(product.getString(TAG_FEMALE));
							txtMmink.setText(product.getString(TAG_MALE));
	...
	class SaveProductDetails extends AsyncTask<String, String, String> {
		...
		protected String doInBackground(String... args) {
			...
			//extra
			String female = txtFmink.getText().toString();
			String male = txtMmink.getText().toString();
			...
			//extra
			params.add(new BasicNameValuePair(TAG_FEMALE, female));
			params.add(new BasicNameValuePair(TAG_MALE, male));
